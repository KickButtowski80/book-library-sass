class BooksController < ApplicationController
  ...
  # Add and remove books from/to library for current_user
  def library
    type = params[:type]
    ...
    if type == 'add'
      ...
      redirect_to root_path, notice: "#{@book.title} was deleted from your library"
    else
      # type is missing, nothing should happend
      redirect_to book_path @book , notice: "Looks like nothing happend, Try again once more!"
